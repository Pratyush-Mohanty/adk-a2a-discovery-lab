...
+----------------+----------------------------+
| The Summarizer | reads a long text and      |
|                | gives you the short        |
|                | version                    |
+----------------+----------------------------+
| The Translator | translates between         |
|                | English, Spanish, French,  |
|                | and Hindi                  |
+----------------+----------------------------+
| The Extractor  | pulls specific facts       |
|                | (names, dates, numbers)    |
|                | out of text                |
+----------------+----------------------------+
| The Classifier | decides a label for text:  |
|                | "is this urgent?", "is     |
|                | this positive or           |
|                | negative?", "what topic is |
|                | this?"                     |
+----------------+----------------------------+
```
...
+------------------------+-------------------------+----------------------------+
| 3. registry            | the shared phone book   | 100% accurate, but ~21 ms  |
|                        |                         | per lookup                 |
+------------------------+-------------------------+----------------------------+
| 4. cached              | sticky notes            | 100% accurate, ~0.03 ms,   |
|                        |                         | 36/36 hits                 |
+------------------------+-------------------------+----------------------------+
| 5a. assistant asleep   | request sent to a dead  | 0% accurate, 2.1 s wait, 3 |
|                        | assistant               | fallbacks                  |
+------------------------+-------------------------+----------------------------+
| 5b. assistant vanished | dead assistant never on | 0% accurate, and zero      |
|                        | the menu                | errors reported            |
+------------------------+-------------------------+----------------------------+
| 5c. assistant recovers | restart an assistant    | back to 100%               |
+------------------------+-------------------------+----------------------------+
| 6. LLM routing         | the smart intern picks  | 100% accurate, 2,266       |
|                        |                         | tokens                     |
+------------------------+-------------------------+----------------------------+
```
...
+----------------------------+----------------------------+----------------------------+
| Tiny, permanent setup      | static (or card discovery) | nothing to build, instant  |
| (demo/prototype)           |                            |                            |
+----------------------------+----------------------------+----------------------------+
| Small team that changes    | card discovery             | reads fresh descriptions   |
| over time                  |                            | once, ~free afterwards     |
+----------------------------+----------------------------+----------------------------+
| Users use your exact words | BM25 or card discovery     | most accurate and cheapest |
|                            |                            | when words match           |
+----------------------------+----------------------------+----------------------------+
| Users paraphrase, tags are | semantic                   | understands meaning, not   |
| messy                      |                            | just vocabulary            |
+----------------------------+----------------------------+----------------------------+
| You can't predict how      | hybrid (BM25 + semantic)   | the only method ≥75% in    |
| users will phrase things   |                            | every test                 |
+----------------------------+----------------------------+----------------------------+
| Big team, many groups,     | registry                   | one source of truth,       |
| need central control       |                            | searchable, governable     |
+----------------------------+----------------------------+----------------------------+
| Big team and you care      | registry + cache           | phone book's benefits at   |
| about speed                |                            | sticky-note speed          |
+----------------------------+----------------------------+----------------------------+
| Genuinely fuzzy requests   | LLM routing                | real understanding — just  |
|                            |                            | pay for it                 |
+----------------------------+----------------------------+----------------------------+
| Any production system      | any method + health checks | no method can spot a       |
|                            | + fallbacks                | vanished assistant         |
+----------------------------+----------------------------+----------------------------+
```
...
+--------------------------+--------------------------+----------------------------+---------+
| Semantic-Layer Injection | Metadata treated as      | Data exfiltration,         | Gate 1  |
|                          | instruction              | unauthorized actions       |         |
+--------------------------+--------------------------+----------------------------+---------+
| Null-as-zero             | Silent upstream failure  | Inverted trend, wrong      | Gate 2  |
|                          |                          | decision                   |         |
+--------------------------+--------------------------+----------------------------+---------+
| Schema drift             | Enum/format changed      | Silent under-count         | Gate 2  |
|                          | underneath               |                            |         |
+--------------------------+--------------------------+----------------------------+---------+
| Stale partition          | Data hasn't landed yet   | Incomplete period reported | Gate 2  |
|                          |                          | as final                   |         |
+--------------------------+--------------------------+----------------------------+---------+
| Outlier / test row       | Unfiltered non-prod data | Aggregates thrown into     | Gate 2  |
|                          |                          | fiction                    |         |
+--------------------------+--------------------------+----------------------------+---------+
```
